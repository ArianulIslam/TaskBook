...
Button addtaskBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setLogo(R.drawable.taskbooicon);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.addtaskbtn) {
            ...
            View view = mylayoutinflater.inflate(R.layout.addtasklayout,null);
            scoreSpinner = (Spinner)view.findViewById(R.id.Scorespinner);
            ...
            scoreSpinner.setAdapter(arrayAdapter);
            drawer.addView(view);
